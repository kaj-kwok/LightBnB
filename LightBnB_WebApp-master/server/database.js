...
const addUser =  function(user) {
  return pool
    ...
    .then((result) => {console.log(user.name + 'added successfully')
...
const getAllReservations = function(guest_id, limit = 10) {
  return pool
    .query(`
      SELECT reservations.id AS id, properties.*, AVG(property_reviews.rating)
      FROM properties
...
const getAllProperties = function(options, limit = 10) {
  ...
  if (options.minimum_price_per_night && options.maximum_price_per_night && options.city) {
...
const addProperty = function(property) {
  pool
    ...
    .catch((err) => console.log("add property error", err.message))
